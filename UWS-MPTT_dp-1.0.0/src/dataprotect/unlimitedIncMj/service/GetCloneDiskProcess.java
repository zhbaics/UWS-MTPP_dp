...
import dataprotect.unlimitedIncMj.model.ClonediskCmd;
    ...
    public void doSomething(){
        ...
        while( !skip && ( cnt < 50 ) ){
            ...
            if( isOk ){
                if( view.initor.mdb.isExistFile( fname ) ){
                    skip = true;
SanBootView.log.info( getClass().getName(),"skip: " + skip);
                    break;
                }
            }
            try {
                ...
                Logger.getLogger(GetCloneDiskProcess.class.getName()).log(Level.SEVERE, null, ex);
            }
            cnt+=1;
        }
