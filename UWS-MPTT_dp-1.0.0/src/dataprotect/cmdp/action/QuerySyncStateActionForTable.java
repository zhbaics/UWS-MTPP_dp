 ...
 */
public class QuerySyncStateActionForTable extends GeneralActionForMainUi{
    public QuerySyncStateActionForTable(){
        super(
...
SanBootView.log.error( getClass().getName(), "can not find host according volume's clntid: "+ volMap.getVolClntID() );
        ...
        BrowserTreeNode node = volMap.getFatherNode();
        
        
        QuerySyncStateDialog dialog = new QuerySyncStateDialog( view,volMap,host ,node);
