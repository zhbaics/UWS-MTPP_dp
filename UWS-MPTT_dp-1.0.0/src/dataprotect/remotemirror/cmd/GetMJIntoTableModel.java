...
package dataprotect.remotemirror.cmd;

import dataprotect.data.BasicVDisk;
import dataprotect.data.MirrorJob;
import dataprotect.data.Pool;
import dataprotect.data.PoolWrapper;
import dataprotect.data.SuspendNetworkRunning;
import dataprotect.data.UWSrvNode;
import dataprotect.remotemirror.ui.multiRenderTable.MjOption;
import dataprotect.remotemirror.ui.multiRenderTable.WrapperOfRemoteUWSAndPool;
...
SanBootView.log.debug(getClass().getName(),"@@@@@: "+value );
            ...
            if( s1.startsWith( MirrorJob.MJ_mj_id ) ){
                ...
                try{
                    ...
                    try {
                        ...
                        Logger.getLogger(GetMJIntoTableModel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    Runnable insertModel = new Runnable(){
        public void run(){
            ...
            if( !curMJ.getMj_info().equals("end") && curMJ.getMj_info().trim().length() != 0 ){
