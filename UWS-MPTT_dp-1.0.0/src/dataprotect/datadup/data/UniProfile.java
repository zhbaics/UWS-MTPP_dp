package dataprotect.datadup.data;
...
public class UniProfile extends AbstractUniProfile implements GeneralInfo,TreeRevealable,TableRevealable{
    ...
    public void outputProfile() throws IOException {
        ...
        try {
            outputStream = new FileOutputStream(profileName);
            OutputStreamWriter out = new OutputStreamWriter(outputStream);
            outputProfile(out);
            outputStream.close();
            out.close();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(UniProfile.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            try {
...
//System.out.println( " line[profile]: "+line+" begin: "+begin );
            ...
            if( line == null || line.length() == 0 || !isTitle( line ) ){
                begin++;
                continue;
            }
