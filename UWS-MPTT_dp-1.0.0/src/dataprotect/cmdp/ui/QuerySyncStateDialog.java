...
public class QuerySyncStateDialog extends javax.swing.JDialog {
    ...
    public QuerySyncStateDialog( SanBootView view,VolumeMap volMap,BootHost host ,BrowserTreeNode node) {
        this( view,true );
        myInit( view,volMap,host ,node);
    }
...
//        refreshHaBtn_process();
    ...
    */
    ...
    private void myInit( SanBootView view,VolumeMap volMap,BootHost host ,BrowserTreeNode node){
        this.view = view;
        this.volMap = volMap;
        this.host = host;
        this.chiefHostVolNode = node;
        ...
        this.jPanel6.remove(this.jPanel8);
    ...
    private void updateWorkState(){
        ...
        if( isOk ){
            if( view.initor.mdb.workStateIsASync() ){
                jLabel2.setText( SanBootView.res.getString("common.button.stop") );
                this.jButton3.setText( SanBootView.res.getString("common.button.up"));
            }else{
                jLabel2.setText( SanBootView.res.getString("common.button.up") );
                this.jButton3.setText( SanBootView.res.getString("common.button.stop"));
            }
        }else{
...
//        this.updateHASupport();
    ...
    private void setupSyncModeBtn_process(){
        ...
        String stateType;
        if( btnText.equals( SanBootView.res.getString("common.button.up")) ){
            stateType = "1";
        }else{
            stateType = "0";
        }
