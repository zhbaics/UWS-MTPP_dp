...
public class WizardDialogSample extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel7.setBorder(new javax.swing.border.EmptyBorder(new java.awt.Insets(5, 1, 5, 1)));
    ...
    ImagePanel imagepanel1 = new ImagePanel( (ImageIcon)ResourceCenter.VerBlue );
    ...
    public void changeLeftImage( ImageIcon icon ){
        imagepanel1.changeit( icon );
        imagepanel1.repaint();
    }
...
//        }catch(BadLocationException ex){ }
            ...
            Logger.getLogger(WizardDialogSample.class.getName()).log(Level.SEVERE, null, ex);
        }
//        }catch(BadLocationException ex){ }
    }
