...
public class RunningTaskForRstLocalDiskForUnix extends javax.swing.JPanel implements RunningTask {
    ...
    public void updateGUI( Hashtable rstList ){
        ...
        int i,size;
        boolean isFirst;
        String src,dest,tmp,precmd,postcmd;
        ...
        while( iterator.hasNext() ){
            ...
            for( i=0; i<size; i++ ){
                ...
                if( isFirst ){
                    ...
                    src1 = new StringBuffer(src);
                    dest1= new StringBuffer(dest);
                    isFirst = false;
                }else{
                    src = binder.lv.toString();
                    dest = binder.destDrv;
                    ...
                    src1.append(" , ").append(src);         //src1+=" , "+src;
                    dest1.append(" , ").append(dest);       //dest1+=" , "+dest;
                }
            }
            ...
            task.task = SanBootView.res.getString("common.restoreLocalDisk.restore") + " " + src1.toString() +" "+ tmp
                     + " " + dest1.toString();
            task.parm = parm;
            task.status = InitTask.INIT_TASK_STA_READY;
            taskList.addElement( task );
