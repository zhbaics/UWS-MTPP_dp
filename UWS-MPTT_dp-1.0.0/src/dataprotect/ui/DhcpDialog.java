...
//        setDefaultCloseOperation(javax.swing.WindowConstants.HIDE_ON_CLOSE);
    ...
    private void setupClntTable(){
        ...
        data = new Object[2+num][4]; //name,desc
...
//        }catch(Exception ex){}
    ...
    private void startOrStopDhcp(){
        ...
        //刷新cache
        view.initor.dhcpdb.setDHCPStartFlag(isStart);
        if( isOk ){
            if( isStart ){
    ...
    void delSubnet(){
        ...
        boolean isOk = view.initor.dhcpdb.dhcpOperation(
            ResourceCenter.BIN_DIR + "dhcp_set.sh delsubnet -s "+conf.subnet
        );
...
//        }
    ...
    void addClnt(){
        ...
        String args="";
        if( conf.dns.length() != 0 ){
            args+=" -d " +conf.dns;
        }
        if( conf.defgw.length() != 0 ){
            args+=" -g " + conf.defgw;
        }
...
//                Logger.getLogger(GenerateDhcpDefConf.class.getName()).log(Level.SEVERE, null, ex);
//            }
...
SanBootView.log.debug(getClass().getName(), " end: "+ endAr.getHostAddress()  );              
            */
            ...
            if( ok ){
                ...
                cmdLine = base + "dhcp_set.sh resetdefault -i " + ipStr;
                view.initor.dhcpdb.dhcpOperation( cmdLine );
