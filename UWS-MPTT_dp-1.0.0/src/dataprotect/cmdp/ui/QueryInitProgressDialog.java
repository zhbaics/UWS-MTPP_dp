...
public class QueryInitProgressDialog extends javax.swing.JDialog implements PropertyChangeListener{
    ...
    public QueryInitProgressDialog( SanBootView view,BootHost host ) {
        this( view, true );
        myInit( view,host );
    }
...
//        }
    ...
    */
    ...
    private void myInit( SanBootView view,BootHost host ){
        this.view = view;
        this.host = host;
    ...
    public void propertyChange(PropertyChangeEvent evt){
        ...
        // 所以要加上ip来区分
        if( msg.equals( "INITPROGRESSINFO" + host.getIP() ) ){
            updateTable( true,"" );
        }
    }
