...
import dataprotect.data.SubNetInDHCPConf;
...
//            Logger.getLogger(EditSubnetDialog.class.getName()).log(Level.SEVERE, null, ex);
//        }
    ...
    void okButton(){
        ...
        */
        ...
        values[5] = Boolean.valueOf( jCheckBox1.isSelected() );
        this.dispose();
    }
