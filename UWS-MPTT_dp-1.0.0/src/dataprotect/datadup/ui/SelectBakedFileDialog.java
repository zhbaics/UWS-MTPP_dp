...
import dataprotect.data.SystemPartitionForUnix;
import java.awt.*;
...
public class SelectBakedFileDialog extends javax.swing.JDialog implements BrowseBakedFile{
    ...
    public SelectBakedFileDialog(
        ...
        this( view,true );
        myInit( view,cli,rootPath,onlyOne,selFileList,excludeFileList,filter_list );
    }
    ...
    public SelectBakedFileDialog( 
        ...
        this( view,cli,rootPath,onlyOne,selFileList,excludeFileList,null );
    }
    ...
    public SelectBakedFileDialog( SanBootView view,BackupClient cli,String selFileList,String excludeFileList,ArrayList<String> filter_list ){
        this( view,cli,"/",false,selFileList,excludeFileList,filter_list );
    }
...
//    }
    ...
    private void myInit( 
        ...
        if( !rootPath.equals("/") && rootPath.length() != 0 ){
    ...
    private boolean isDir( String file ){
        if( file.length() == 0 ) return true; // for linux
...
//System.out.println(" / is selected, " + " compared file: "+ selFile ); 
    ...
    private void setTextOnTextField1( String curPath ){
        ...
        try {
            ...
            Logger.getLogger(SelectBakedFileDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
