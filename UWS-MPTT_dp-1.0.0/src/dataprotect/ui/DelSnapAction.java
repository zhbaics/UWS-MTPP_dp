...
import dataprotect.unlimitedIncMj.service.ProcessEventOnChiefUIMSnap;
import dataprotect.unlimitedIncMj.service.ProcessEventOnUnlimitedIncMirrorVol;
...
SanBootView.log.info(getClass().getName(),"cancel this action. \n########### End of delete snap action. " );
        ...
        if( delSnap.isOK() ){
            audit.setEventDesc( "Delete snapshot: " + snap_name + " successfully." );
            ...
            audit.setEventDesc( "Failed to delete snapshot: " + snap_name );
            view.audit.addAuditRecord( audit );
    ...
    class DelSnapshot extends Thread{
        ...
        @Override public void run(){
            ...
            if( !isOk ){
                ...
                if(this.errcode == -1){
                    this.errmsg = SanBootView.res.getString("DelSnap.error.hasActivelink");
                } else {
                    this.errmsg = SanBootView.res.getString("DelSnap.error.hasView");
                }
            }else{
