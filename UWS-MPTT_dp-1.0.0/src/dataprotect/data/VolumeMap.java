...
*/
    ...
    public void addFunctionsForTable(){
        if( fsForTable == null ){
            ...
            if( this.isCMDPProtect() ){
                fsForTable.add( new Integer( MenuAndBtnCenterForMainUi.FUNC_PHY_QUERY_SYNC_STATE_TABLE ) );
    ...
    public boolean isOsVolMap(){
        if( vol_disklabel != null && vol_disklabel.length() != 0 ){
