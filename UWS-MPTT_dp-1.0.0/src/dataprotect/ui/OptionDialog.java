...
import dataprotect.data.GUIAdminOpt;
import dataprotect.data.GUIAdminOptGlobal;
...
import mylib.tool.*;
import dataprotect.logging.MyLogger;
...
//        langs.add( SanBootView.res.getString("common.jp") );
    ...
    public void setupTable( GUIAdminOptUWS uws ){
        ...
        tableColumnModel.getColumn(0).setWidth( 155 );
...
//            port = ResourceCenter.C_S_PORT;
        ...
        if( !aLang.equals(tmpLang) ){
            JOptionPane.showMessageDialog( view,
                    SanBootView.res.getString("ConnectDialog.message.changedLang")
                );
        }
