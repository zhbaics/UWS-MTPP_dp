...
import dataprotect.datadup.data.Clock;
...
public class MirrorGrp {
    ...
    public final static int MG_DEFAULT_MIN_INCREMENT_SIZE = 0; //unit: bytes ( original val: 65536)
    ...
    private int mg_schedule_type = 0;    // 0: rotate   1：cron
...
System.out.println("[3600*24, 无穷大], day="+day+" hour="+hour+" min="+min );
    ...
    public String getCronSchString(){
        ...
        if( this.isCronType() ){
            ...
            String clock_zone = (this.mg_schedule_clock_zone.length() == 0 )?"":", "+SanBootView.res.getString("common.clockZoneCtrl")+" "+this.mg_schedule_clock_zone;
...
//                isFirst = false;
    ...
    public boolean hasClockZone(){
        return mg_schedule_clock_zone.length() != 0;
    }
