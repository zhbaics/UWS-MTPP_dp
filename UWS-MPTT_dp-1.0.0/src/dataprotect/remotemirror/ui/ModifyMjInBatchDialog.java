...
import dataprotect.remotemirror.ui.multiRenderTable.MyDefaultTableModelForTableForModifyMj;
import dataprotect.remotemirror.ui.multiRenderTable.TableForModifyMj;
    ...
    */
    ...
    private void do_selCheckBox(){
        ...
        for( int row=0; row<lineNum; row++ ){
            model.setValueAt( Boolean.valueOf( this.jCheckBox1.isSelected() ), row, 0 );
        }
        fireEditingStopMsg();
    }
