...
import dataprotect.remotemirror.ui.multiRenderTable.MirrorJobOptionPaneEditor;
import dataprotect.remotemirror.ui.multiRenderTable.MirrorJobRemoteUWSPaneEditor;
import dataprotect.remotemirror.ui.multiRenderTable.MjOption;
import dataprotect.remotemirror.ui.multiRenderTable.MyDefaultTableModelForTableForCreateMj;
import dataprotect.remotemirror.ui.multiRenderTable.TableForCreateMj;
...
import dataprotect.ui.InputPasswordDiag;
import dataprotect.ui.SanBootView;
import dataprotect.ui.SlowerLaunch;
import dataprotect.ui.multiRenderTable.CheckBoxEditor;
import dataprotect.ui.multiRenderTable.MyComboBoxEditor;
    ...
    */
    ...
    private void do_selCheckBox(){
        ...
        for( int row=0; row<lineNum; row++ ){
            model.setValueAt( this.jCheckBox1.isSelected(), row, 0 );
        }
        fireEditingStopMsg();
    }
...
SanBootView.log.debug(this.getClass().getName(), "mirror job type to create: " + type );
            ...
            if( pwdMap.get( wrapper.uwsNode.getUws_id()+wrapper.pool.pool.getPool_id()+"" ) == null ){
                if( wrapper.pool.pool.getPool_passwd().length() != 0 ){
