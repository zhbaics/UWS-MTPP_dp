...
public class SetDhcpPane extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextField3.setPreferredSize(new java.awt.Dimension(99, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jTextField4.setPreferredSize(new java.awt.Dimension(99, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jPanel7.add(jPanel9);
        jPanel9.setBounds(0, 13, 475, 105);
    ...
    public void initDhcpSetupPane( 
        ...
        this.initDhcpSetupPane(_ibootSrvList, _subnetList, newmac, isUseOdyDhcp, _olddhcpClnt, ip,ip,view.initor.getTxIP() );
    }
    ...
    public boolean checkDhcpInfoValidity(){        
        if( jRadioButton1.isSelected() ){
            ...
            try{
                InetAddress ip_3rd1 = InetAddress.getByName( ip_3rd );
                System.out.print(ip_3rd1);
            }catch(Exception ex){
                JOptionPane.showMessageDialog(this,
            ...
            try{
                InetAddress nextServer_3rd1 = InetAddress.getByName( nextServer_3rd );
                System.out.print(nextServer_3rd1);
            }catch(Exception ex){
                JOptionPane.showMessageDialog(this,
