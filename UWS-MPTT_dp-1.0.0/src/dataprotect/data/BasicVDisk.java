...
public class BasicVDisk implements Comparable{
    ...
    public String getSnapType(){
        if( this.isSnap() ){
            return SanBootView.res.getString("common.snap.manual_type");
        }else if( this.isMirroredSnap() ){
            return SanBootView.res.getString("common.snap.auto_type");
        }else{
