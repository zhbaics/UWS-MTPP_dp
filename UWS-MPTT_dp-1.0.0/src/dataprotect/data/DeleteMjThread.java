...
SanBootView.log.error( getClass().getName()," Can't get source_end target server host name(PSN)." );
        ...
        if( !isLocalType ){
            ...
            if( !isOk ){
                ...
                if( src_uws == null ){
                    src_uws = new UWSrvNode( -1, view.initor.getTxIP(), UWSrvNode.MEDIA_SERVER_PORT, psn );
                        ...
                        if( isOk && delHostInfo ){
                            ...
                            if( !isOk ){
                                ...
                                if( tmpSrcAgnt == null ){
                                    ...
                                    isOk = crtSrcAgent( view.initor.getTxIP(), psn, "","", src_uws.getUws_id(), -1 );
                                }else{
                                    srcAgnt = tmpSrcAgnt;
                                }
