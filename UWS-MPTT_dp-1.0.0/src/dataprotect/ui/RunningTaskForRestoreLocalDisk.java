        ...
        while( iterator.hasNext() ){
            ...
            for( i=0; i<size; i++ ){
                ...
                if( isFirst ){
                    ...
                    srcDest = new BindOfSrcAndDest( src,dest );
                    parm.addElement( srcDest );
                    StringBuffer src1_sb = new StringBuffer(src1);
                    StringBuffer dest1_sb = new StringBuffer(dest1);
                    src1_sb.append(" , ").append(src);                          //src1+=" , "+src;
                    dest1_sb.append(" , ").append(dest);                        //dest1+=" , "+dest;
                    src1 =  src1_sb.toString();
                    dest1 = dest1_sb.toString();
                }
            }
