...
import dataprotect.datadup.ui.MonthlyPane;
import dataprotect.datadup.ui.SchedDialog;
import dataprotect.datadup.ui.WeeklyPane;
...
//            }catch(Exception ex){}
    ...
    private String getHourFreq(int step){
        ...
        for(int i=0;i<24;i+=step){
            if( isFirst ){
                ret = new StringBuffer(i+"");
                isFirst = false;
            }else{
                ret.append(",").append(i);        //ret += ","+i;
            }
        }
        return ret.toString();
    }
