...
import dataprotect.datadup.data.UniProDrive;
import dataprotect.datadup.data.UniProHeader;
import dataprotect.datadup.data.UniProIBoot;
...
public class ModifyProfileThread {
    ...
    public boolean realRun(){
        ...
        for( int i=0; i<size; i++ ){
            ...
            // source_dest_reference=C:\-?odytarget://20.20.1.144:3260@<iqn>.iscsi.uws404:32779
            // source_dest_reference=/boot-?odytarget://20.20.1.144:3260@<iqn>.iscsi.uws404:32769-?/-?odytarget://20.20.1.144:3260@<iqn>.iscsi.uws404:32768
            ...
            // path = odytarget://20.20.1.144:3260@<iqn>.iscsi.uws404:32769-?odytarget://20.20.1.144:3260@<iqn>.iscsi.uws404:32768
