...
public class EditPhyProfileDialog extends javax.swing.JDialog {
    ...
    */
    ...
    private void myInit( SanBootView view,PPProfile ppprof,Vector services ){
        ...
        jPanel4.remove( this.jCheckBox1 );
    ...
    private boolean checkValid(){
        ...
        if( this.jRadioButton1.isSelected() ){
            ...
            if( this.jTextArea1.getText().equals( SanBootView.res.getString("common.nonLinearContent") ) ||
                this.jTextArea1.getText().length() == 0
            ){
                ret = false;
        ...
        try{
            ...
            if( maxSnap <=0 || maxSnap > ResourceCenter.MAX_SNAP_CMDP_NUM ){
                ...
                JOptionPane.showMessageDialog(this, SanBootView.res.getString("EditProfileDialog.error.invalidMaxSnap")+ResourceCenter.MAX_SNAP_CMDP_NUM 
                                        + SanBootView.res.getString( "EditProfileDialog.error.invalidMaxSnap2" ) );
            }
        }catch(Exception ex){
            ret = false;
            JOptionPane.showMessageDialog(this, SanBootView.res.getString("EditProfileDialog.error.invalidMaxSnap")+ResourceCenter.MAX_SNAP_CMDP_NUM );
        ...
        if( ( orgDiskNum == 1) && ( selDiskNum > 1 ) ){ // single disk ===> drivegroup
            ...
            if( profileItem != null ){
                ...
                if( volMap != null ){
                    String diskLabel = volMap.getVolDiskLabel();
                    if( !hasContainOne( diskLabel, selDisks ) ){
